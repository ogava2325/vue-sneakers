...
namespace VueSneakers.API.Contollers
{
    ...
    public class FavoritesController : ControllerBase
    {
        ...
        // GET: api/Favorites/5
        [HttpGet("{id}")]
        public async Task<ActionResult<Favorite>> GetFavorites(int id)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutFavorites(int id, Favorite favorite)
        {
            if (id != favorite.Id)
            {
                return BadRequest();
        ...
        // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
        [HttpPost]
        public async Task<ActionResult<Favorite>> PostFavorites(Favorite favorite)
        {
